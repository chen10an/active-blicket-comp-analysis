...
# SET THESE VARS -----
SAVEDIR <- "cache/noSig-1"  # ablate sigmoid space by considering only the disjunctive form
createDirs(SAVEDIR)
...
print(sprintf("Caching %i remaining participants.", length(notCachedSess)))
