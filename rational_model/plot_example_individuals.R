...
legend <- get_legend(plotSess("tIYHuqfEBgwlABY0gupUDLygem3py3Pg"))

hbmP <- plotSess("tIYHuqfEBgwlABY0gupUDLygem3py3Pg") + ggtitle("HBM Participant") + theme(legend.position = "none")

noTransferP <- plotSess("bh9MvmNflP9cVw63DvOMSx9qFBTWRkY0") + ggtitle("No-Transfer Participant") + theme(legend.position = "none")

structOnlyP <- plotSess("Ij9QDxN1mbdDGRw6EfZr1gS90dlad5zu") + ggtitle("Structure-Only-EIG Participant") + theme(legend.position = "none")
