...
# SET THESE VARS -----
SAVEDIR <- file.path(args$cache_dir, "2022-04-18_main", sprintf("%.2f-%.2f_%.2f-%.2f_%.2f", args$bias_shape, args$bias_scale, args$gain_shape, args$gain_scale, args$width))  # main model, no ablations
createDirs(SAVEDIR)
