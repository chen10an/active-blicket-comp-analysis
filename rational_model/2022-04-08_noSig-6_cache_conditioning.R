...
# SET THESE VARS -----
SAVEDIR <- file.path(args$cache_dir, "2022-04-08_noSig-6")  # ablate the sigmoid space by considering only an enumerated space of 6 forms (same as experimental manipulations)
createDirs(SAVEDIR)
